...
<style lang="scss">
    ...
    .media-library-container {
        ...
        .media-card {
            ...
            .media-info {
                padding: 1.5rem;
                h3 { margin: 0 0 0.5rem 0; color: #2c3e50; font-weight: bold; }
                .media-meta { font-size: 0.85rem; color: #95a5a6; margin-bottom: 1rem; }
                .media-description { font-size: 0.9rem; color: #34495e; line-height: 1.4; }
            }
        }
